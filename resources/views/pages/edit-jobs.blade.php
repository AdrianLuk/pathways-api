...
@section('content')
    ...
    <h2 class="text-center">Editing {{$jobs->name}}'s Listing</h2>

    <form class="p-5 mt-5 bg-white" action="/listing/{{$jobs->id}}" method="post">
        {{ csrf_field() }}
    ...
    <input type="hidden" name="_method" value="PATCH">
        ...
        <div class="form-group">
          ...
          <input name="name" type="text" class="form-control form-control-lg" id="name" value="{{$jobs->name}}">
        </div>
...
<div class="form-row">
        ...
        <div class="form-row">
            <div class="form-group col-lg-6">
              ...
              <input name="telephone" type="tel" class="form-control form-control-lg" id="telephone" value="{{$jobs->telephone}}">
              </div>
             <div class="form-group col-lg-6">
                 <label for="postal" class="col-form-label text-uppercase font-weight-bold">Postal Code <span class="text-danger">*</span></label>
                 <input type="text" name="postal" class="form-control form-control-lg" id="postal" value="{{$jobs->postal}}">
            </div>
        </div>
        <div class="form-group">
          <label for="salary" class="form-control-label text-uppercase font-weight-bold">Salary <span class="text-danger">*</span></label>
          <input name="salary" type="text" class="form-control form-control-lg" id="salary" value="{{$jobs->salary}}">
        </div>
